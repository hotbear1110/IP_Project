...
public class BoardFactory {
    ...
    public static Square[] makeBoard(){
        ...
        board[10] = new VisitJailSquare(Translator.getString("SQUARE_10"),"","");
        ...
        board[12] = new Brewery(Translator.getString("SQUARE_12"),"","", 3000, 0, PricesFactory.rentTable()[6], Color.black);
        ...
        board[15] = new Ship(Translator.getString("SQUARE_15"),"","", 4000, 0, PricesFactory.rentTable()[9], Color.white);
        ...
        board[28] = new Brewery(Translator.getString("SQUARE_28"),"","", 3000, 0, PricesFactory.rentTable()[18], Color.black);
        ...
        board[30] = new GoToJailSquare(Translator.getString("SQUARE_30"),"","");
        ...
        board[35] = new Ship(Translator.getString("SQUARE_35"),"","", 4000, 0, PricesFactory.rentTable()[23], Color.white);
